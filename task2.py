...
#position
sLabel.grid(row = 1, column = 14, sticky = E)
sEntry.grid(row = 1, column = 15)
label1.grid(row = 2, column = 12)
doglabel.grid(row = 1, column = 1, rowspan = 3, columnspan =2)
name.grid(row = 5, column = 1)
nEntry.grid(row = 6, column = 1, sticky= E)
...
pbutton.grid(row = 8, column = 1, sticky = W)
save.grid(row = 7, column = 12, rowspan = 1, sticky="s")
nbutton.grid(row = 8, column = 15, sticky = E)
window.mainloop()